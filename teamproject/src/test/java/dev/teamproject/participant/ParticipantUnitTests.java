...
/**
 * This class contains unit tests for the pariticpant class.
...
public class ParticipantUnitTests {
  ...
  void testSetMeeting() {
    ...
    assertEquals(newMeeting, participant.getMeeting(),
            "Meeting should be updated correctly.");
  }
  ...
  void testGetJoinAt() {
    ...
    assertTrue(joinAt.getTime() <= System.currentTimeMillis(),
            "JoinAt timestamp should be in the past or present.");
  }
