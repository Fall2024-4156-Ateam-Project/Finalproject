...
class RequestServiceTests {
    ...
    void testDeleteRequestNotFound() {
        ...
        assertThrows(RuntimeException.class, () -> requestService.deleteRequest(timeSlot.getTid(), user.getUid()));
    }
    ...
    void testUpdateRequestDescription() {
        ...
        Request updatedRequest = requestService.updateRequestDescription(timeSlot.getTid(), user.getUid(), "New Description");
    ...
    void testUpdateRequestStatus() {
        ...
        Request updatedRequest = requestService.updateRequestStatus(timeSlot.getTid(), user.getUid(), CommonTypes.RequestStatus.approved);
