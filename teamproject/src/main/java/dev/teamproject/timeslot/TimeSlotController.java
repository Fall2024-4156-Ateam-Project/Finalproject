...
/**
 * REST controller for managing TimeSlot entities. Provides endpoints for creating, retrieving,
 * updating, and deleting TimeSlots.
 */
...
public class TimeSlotController {
  ...
  public ResponseEntity<TimeSlot> updateTimeSlotNoOverlap(
    ...
    if (!valid) {
      return ResponseEntity.badRequest().body(timeSlot);
    }
